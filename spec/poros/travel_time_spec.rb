...
RSpec.describe TravelTime, type: :poros do
  describe 'initialize', :vcr do
    it 'creates a travel time object' do
      raw_data = { route: { sessionId: 'AIcA5wcAAAUBAAAHAAAABQAAAJ8AAAB42mOYz8DAyMTAwMCekVqUapWcK8ppLM3AwMCgYLJ9B4fVyTDTTUVOMSB6c5FTDAMWANO47nwfWOMzkd2CTKb3Z5v-32waDaMZcAD52UobrzEwMDR4sHAE8QowKDAwOIDEG0BUgwIDFwcbAFQoIJ1ST5VB:car',
                            realTime: 6127,
                            distance: 113.6227,
                            time: 5917,
